...
const texture = loader.load('tiger.jpg')
const normalmap = loader.load('tiger.jpg')
const heightmap = loader.load('tiger.jpg')
const roughmap = loader.load('tiger.jpg')
const ambientOcclusionmap = loader.load('tiger.jpgg')
const metallicmap = loader.load('tiger.jpg')
// plane
